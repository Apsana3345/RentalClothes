  ...
  return (
    ...
    >
      <div className="max-w-[1440px] w-full ">
        <div className="flex md:flex-row flex-col md:justify-around justify-center items-center p-4">
          ...
          <div className="flex flex-col justify-center gap-2 mt-10 sm:pt-0">
            <h1 data-aos="fade-up" className="text-2xl sm:text-2xl font-bold">
              {" "}
              Festive Sales{" "}
            </h1>
            <p
            ...
            >
              ...
              maxime maiores ipsam dolor voluptatem magni .Lorem ipsum, dolor .
            </p>
